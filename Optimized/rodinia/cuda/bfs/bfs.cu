...
void BFSGraph( int argc, char** argv) 
{
	...
	size_t size =  min( (int)(no_of_nodes * sizeof(bool)),  prop.persistingL2CacheMaxSize ); 
	...
	stream_attribute.accessPolicyWindow.base_ptr  =  reinterpret_cast<void*>(d_graph_visited);  // Global Memory  data pointer stream_attribute.accessPolicyWindow.num_bytes = window_size;  // Number of bytes for persistence access
