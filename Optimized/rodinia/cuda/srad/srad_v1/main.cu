...
__constant__ int constant_d_jW[MAX_WIDTH];
__constant__ int constant_d_jE[MAX_WIDTH];
...
int main(int argc, char *argv []){
	...
	cudaMemcpyToSymbol(constant_d_jW, jW, mem_size_j, 0, cudaMemcpyHostToDevice);
	cudaMemcpyToSymbol(constant_d_jE, jE, mem_size_j, 0, cudaMemcpyHostToDevice);
