#!/bin/bash
# run_all.sh
# Profiles every Origin/ application with ncu (Nsight Compute).
...
OPT="${SCRIPT_DIR}"
DATA="${OPT}/rodinia_3.1/data"

add_app "rodinia/backprop"          "${OPT}/rodinia_3.1/cuda/backprop"      "./backprop"             "65536"
add_app "rodinia/bfs"               "${OPT}/rodinia_3.1/cuda/bfs"           "./bfs"                  "${DATA}/bfs/graph1MW_6.txt"
add_app "rodinia/hotspot"           "${OPT}/rodinia_3.1/cuda/hotspot"       "./hotspot"              "512 2 2 ${DATA}/hotspot/temp_512 ${DATA}/hotspot/power_512 output.out"
add_app "rodinia/srad_v1"           "${OPT}/rodinia_3.1/cuda/srad/srad_v1"  "./srad"                 "100 0.5 502 458"
...
add_app "XSBench"                   "${OPT}/XSBench/cuda"                   "./XSBench"              "-s large -m event -l 17000000"
